...
public class ImplParticule implements Particule {

    private final UpdaterManager<Particule> updaterManager;
    ...
    public ImplParticule(ZeldaLike zeldaLike, Color color, Vector location, int lifetime) {
        this(zeldaLike, null, color, location, lifetime);
    }

    public ImplParticule(ZeldaLike zeldaLike, Image texture, Vector location, int lifetime) {
        this(zeldaLike, texture, Color.color(0, 0, 0), location, lifetime);
    }

    public ImplParticule(ZeldaLike zeldaLike, Image texture, Color color, Vector location, int lifetime) {
    ...
    @Override
    public UpdaterManager<Particule> getUpdaterManager() {
